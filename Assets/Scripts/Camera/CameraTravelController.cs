...
public class CameraTravelController : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        _mainCamera = _cameraSwitcher.transform.FindChild("MainCamera")
                                .GetComponent<Camera>();
    ...
    private void ActualizeState()
    {
        ...
        if (waitTime > currentObjective.waitTime)
        {
            ...
            if (++index == objectivesList.Objectives.Count) { 
                ...
                _cameraSwitcher.transform.FindChild("MainCamera").GetComponent<MainCameraController>().startPosition = transform.position;
                _cameraSwitcher.transform.FindChild("MainCamera").transform.position = transform.position;
